...
class Prosta_Pionowa;
    ...
    Prosta_Pionowa::Prosta_Pionowa(double X) : wartosc_x(X) {};
    //Prosta_Pionowa::Prosta_Pionowa(Punkt A, Punkt B ) : wartosc_x(A.wsp_x) {}
    Prosta_Pionowa::Prosta_Pionowa(Punkt &A, Punkt &B) : wartosc_x(A.wsp_x) {}

double Prosta_Pionowa::get_x() {return wartosc_x;};

bool Prosta_Pionowa::operator<(Punkt & P) 
        {
        if (P.wsp_x > this->wartosc_x) {return 1;}
        else {return 0;}
        };
...
//****************************************************************
    ...
    void Prosta_Pionowa::wyswietl_swoj_wzor()
    {
        std::cout<<"x = " << this->wartosc_x << "\n" ;
     };



    void Prosta_Pionowa::rysuj(ASCIICanvas & E)
    {
{
...
void Prosta_Pionowa::wypisz_punkty() { std::cout << " ";}
void Prosta_Pionowa::rysuj_cien(ASCIICanvas & E, Light light, char symbol_tla, char symbol_cienia) { std::cout << " " ; }